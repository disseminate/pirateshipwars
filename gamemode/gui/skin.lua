...
SKIN.PrintName 		= "Pirate Ship Wars";
SKIN.Author			= "Disseminate";
SKIN.DermaVersion	= 1;

SKIN.fontFrame					= "PSW_20";
SKIN.fontTab					= "PSW_20";
SKIN.fontButton					= "PSW_20";
SKIN.fontCategoryHeader			= "PSW_20";

SKIN.mainColor					= Color( 0, 0, 0, 200 );
SKIN.mainColorLight				= Color( 0, 0, 0, 100 );
...
SKIN.Colours.Button.Hover				= GWEN.TextureColor( 4 + 8 * 2, 500 );
...
function SKIN:PaintFrame( panel, w, h )
	...
	GAMEMODE:DrawBoxLines( Color( 50, 50, 50, 255 ), 0, 0, w, 24, 5 );
...
function SKIN:PaintButton( panel, w, h )
	...
	if( panel.m_bBackground ) then
		...
		if( d ) then
			...
			GAMEMODE:DrawGradientBox( c, 0, 0, w, h );
...
function SKIN:PaintButtonDown( panel, w, h )
	...
	draw.DrawText( "u", "marlett", 1, 2, Color( 200, 200, 200, 255 ) );
...
function SKIN:PaintButtonUp( panel, w, h )
	...
	draw.DrawText( "t", "marlett", 1, 2, Color( 200, 200, 200, 255 ) );
...
function SKIN:PaintTextEntry( panel, w, h )
	...
	panel:DrawTextEntryText( Color( 255, 255, 255, 255 ), Color( 255, 255, 255, 255 ), Color( 255, 255, 255, 255 ) );
	
end

derma.DefineSkin( "LSSkin", "LuaShake Skin", SKIN );
